...
export default class Fellowship extends Page {
	...
	render() {
		...
		return (
			<div className='page page--fellowship' ref='page-wrapper'>
				...
				<div className='fellowship js-smooth'>
					<section className='fellowship__presentation'>
						<p data-speed='.2' className='js-parallax paragraph paragraph--big paragraph--center' data-ease='.0'>A fellowship is a communion of people sharing a common passion.</p>
						<p data-speed='.2' className='js-parallax paragraph paragraph--small paragraph--center'>In Cuba generations of aspiring distillers have followed the example of a seasoned rum master and so learnt to develop and perfect their craft. The Elliott Erwitt Havana Club 7 Fellowship combines this rich history and tradition with a passion for documentary photography.</p>
						<p data-speed='.2' className='js-parallax paragraph paragraph--medium paragraph--center'>Master photographer Elliott Erwitt’s lifelong love of photography and Cuba has brought him back to Cuba again after 51 years – this time to initiate the fellowship with Havana Club 7.</p>
						<div className='paragraph__row js-limit'>
							<div data-speed='.05' className='js-parallax paragraph__column paragraph__column--left'>
								<img className='fellowship__elliott' src='../assets/images/elliott-erwitt.jpg' />
							</div>
							<div className='paragraph__column'>
								<p data-speed='.2' className='js-parallax paragraph paragraph--small'>A new body of work will create a starting point for a new generation of photographers to relate to, to further develop their craft and help (re)define the genre in the 21st century.  Inspired by Elliott Erwitt, exceptional talents selected for the fellowship will each create a unique body of work, capturing the soul of Cuba which will be shared with photography lovers worldwide.</p>
							</div>
						</div>
						<p data-speed='.2' className='js-parallax paragraph paragraph--medium paragraph--center'>In the spirit of Cuba, 7 photos of each fellow will be sold to support the next photographer joining the fellowship and thus offering each photographer the opportunity to benefit the next in line to carry on the legacy.</p>
						<div className='paragraph__row'>
							<div className='paragraph__column'>
								<p data-speed='.2' className='js-parallax paragraph paragraph--small'>In addition to the proceeds from print sales Havana Club 7 will fund a similar amount to give more photographers the chance to tell the story of Cuba.</p>
							</div>
							<div data-speed='.1' className='js-parallax paragraph__column paragraph__column--right'>
								<img className='fellowship__elliott' src='/static/img/ERE2015002W00033-36A_medium.jpg' />
							</div>
						</div>
						<p data-speed='.2' className='js-parallax paragraph paragraph--small paragraph--center'>The following fellowship photographers will be selected by a committee headed by Elliott Erwitt comprising of Cuban and international photography professionals ensuring the next fellow will continue the legacy of cuba and the human condition in Cuba through documentary photography and give us their own vision.</p>
					</section>
					<div data-speed='.1' className='js-parallax discover fellowship__discover' onClick={this._goToBiographyBinded}>
					...
					<section className='fellowship__artist'>
						...
						<p data-speed='.2' className='js-parallax paragraph paragraph--small paragraph--center'>Born in Paris in 1928 to Russian parents, Erwitt moved to the US with his family in 1939 and it was there that he met Edward Steichen and Roy Stryker. Recruited to Magnum Photos by Robert Capa in 1953 Erwitt has been a member of the prestigious agency ever since and has served several terms as its president.</p>
						<div className='paragraph__row'>
							<div className='paragraph__column'>
								<p data-speed='.2' className='js-parallax paragraph'><a className='fellowship__button button' href='http://www.elliotterwitt.com' target='_blank'><span className='button__content'>Elliott Erwitt official website</span></a></p>
							</div>
							<div className='paragraph__column'>
								<p data-speed='.2' className='js-parallax paragraph paragraph--small'>To date Erwitt has produced more than 25 photography books including Eastern Europe (1965), The Private Experience (1974), Personal Exposures (1988), To the Dogs (1992), and Personal Best (2010). His photographs have been featured in solo shows all over the world, including at the ICP and The Museum of Modern Art, New York; The Art Institute of Chicago; The Barbican, London, and The Reina Sofia Museum, Madrid. Erwitt lives and works in New York City and likes children and dogs.</p>
							</div>
						</div>
						<div className='button js-parallax'><a href='#/project/elliott-erwitt' className='fellowship__button button__content'>Discover his project</a></div>
					</section>
				</div>
			</div>
		)
	...
	_handleScroll() {
		...
		_(dom('.js-parallax')).forEach((el, index) => {
