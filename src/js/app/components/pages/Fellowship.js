			...
			<div className='page fellowship' ref='page-wrapper'>
				...
				<section className='fellowship__artist'>
					...
					<div className='fellowship__links'>
						{(() => {
							if (that.state.view === 'biography') { return (
								<div className='fellowship__link' onClick={that.showInterviewBinded}>Video interview</div>
							)} else { return (
								<div className='fellowship__link' onClick={that.showBiographyBinded}>Biography</div>
							)}
						})()}
						<a href='#/project/elliott-erwitt' className='fellowship__link'>His project</a>
					</div>
				</section>
